...
export const menuItems: MenuItem[] = [
    ...
    children: [
      ...
      },
      {
        ...
        items: [
          ...
          { label: "Magnesium", href: "/tig-welding/filler-rods/magnesium" },
    ...
    children: [
      ...
      },
      {
        ...
        items: [
          ...
          { label: "Dissimilar Steel", href: "/arc-mma/electrodes/dissimilar" },
    ...
    children: [
      {
        ...
        items: [
          ...
          { label: "Plasma Torch Spares", href: "/plasma-cutting/plasma/torch-spares" },
          { label: "Sif Weld Cut 40 Spares", href: "/plasma-cutting/plasma/sif-weld-cut-40-spares" },
          { label: "Sif Weld Cut 100 Spares", href: "/plasma-cutting/plasma/sif-weld-cut-100-spares" },
  ...
  // 5. WIRE & RODS
  {
    ...
    children: [
      ...
      },
      {
        ...
        href: "/tig-welding/filler-rods",
        items: [
          { label: "Aluminium TIG Rods", href: "/tig-welding/filler-rods/aluminium" },
          { label: "Brazing / Bronze TIG Rods", href: "/tig-welding/filler-rods/brazing" },
          { label: "Copper / Copper-Nickel TIG Rods", href: "/tig-welding/filler-rods/copper" },
          { label: "Dissimilar Steel TIG Rods", href: "/tig-welding/filler-rods/dissimilar" },
          { label: "Duplex Stainless TIG Rods", href: "/tig-welding/filler-rods/duplex" },
          { label: "Hard Facing TIG Rods", href: "/tig-welding/filler-rods/hard-facing" },
          { label: "Magnesium TIG Rods", href: "/tig-welding/filler-rods/magnesium" },
          { label: "Mild Steel TIG Rods", href: "/tig-welding/filler-rods/mild-steel" },
          { label: "Nickel Alloy TIG Rods", href: "/tig-welding/filler-rods/nickel" },
          { label: "Stainless Steel TIG Rods", href: "/tig-welding/filler-rods/stainless" },
          { label: "Titanium TIG Rods", href: "/tig-welding/filler-rods/titanium" },
        ],
      },
      {
        heading: "MMA Welding Electrodes",
        href: "/arc-mma/electrodes",
        items: [
          { label: "Cast Iron Electrodes", href: "/arc-mma/electrodes/cast-iron" },
          { label: "Cutting / Gouging Electrodes", href: "/arc-mma/electrodes/cutting-gouging" },
          { label: "Dissimilar Steel Electrodes", href: "/arc-mma/electrodes/dissimilar" },
          { label: "Hard Surfacing Electrodes", href: "/arc-mma/electrodes/hard-surfacing" },
          { label: "Stainless Steel Electrodes", href: "/arc-mma/electrodes/stainless" },
          { label: "Steel & Low Hydrogen Electrodes", href: "/arc-mma/electrodes/steel" },
        ],
      },
      {
  ...
  // 6. CONSUMABLES
  {
    ...
    children: [
      {
        heading: "MIG Supplies",
        href: "/mig-welding/supplies",
        items: [
          { label: "Binzel-Style Consumables", href: "/mig-welding/torches/binzel-consumables" },
          { label: "Euro MIG Torches", href: "/mig-welding/torches/euro" },
          { label: "MIG Liners", href: "/mig-welding/torches/liners" },
          { label: "MIG Welding Nozzles", href: "/mig-welding/torches/nozzles" },
          { label: "MIG Welding Wire", href: "/mig-welding/wire" },
        ],
      },
      {
        heading: "TIG Supplies",
        href: "/tig-welding/supplies",
        items: [
          { label: "TIG Torch Consumables", href: "/tig-welding/torches/consumables" },
          { label: "TIG Torches & Spare Parts", href: "/tig-welding/torches/all" },
          { label: "TIG Welding Filler Rods", href: "/tig-welding/filler-rods" },
          { label: "Tungsten Electrodes", href: "/tig-welding/tungsten" },
        ],
      },
      {
        heading: "Arc/MMA Supplies",
        href: "/arc-mma/supplies",
        items: [
          { label: "Earth Clamps", href: "/arc-mma/earth-clamps" },
          { label: "Electrode Holders", href: "/arc-mma/electrode-holders" },
          { label: "MMA Welding Electrodes", href: "/arc-mma/electrodes" },
          { label: "Welding Cable & Accessories", href: "/arc-mma/cable" },
        ],
      },
      {
        heading: "Chemicals & Ceramics",
        href: "/consumables/chemicals",
        items: [
          { label: "Anti-Spatter Spray", href: "/consumables/chemicals/anti-spatter" },
          { label: "Devcon Maintenance Products", href: "/workshop/devcon" },
          { label: "Disposable Gas Cylinders", href: "/gas-oxy-fuel/disposable-cylinders" },
          { label: "Weld Backing Ceramics", href: "/workshop/consumables/ceramics" },
          { label: "Weld Backing Tapes", href: "/workshop/pipe/backing-tape" },
  ...
  // 7. GAS
  {
    ...
    children: [
      ...
      {
        heading: "Gas Safety & Accessories",
        ...
        items: [
          ...
          { label: "Gas Arc Spares & Certificates", href: "/gas-oxy-fuel/regulators/gas-arc-spares" },
          { label: "Gas Economiser Spares", href: "/gas-oxy-fuel/economisers/spares" },
          { label: "Gas Economisers / Flowmeters", href: "/gas-oxy-fuel/economisers" },
        ],
      },
      {
        heading: "Gas Hoses & Storage",
    ...
    children: [
      ...
      },
      {
        ...
        items: [
          ...
          { label: "Welding Capes & Sleeves", href: "/safety/clothing/capes" },
          { label: "Welding Caps & Balaclavas", href: "/safety/clothing/caps" },
          ...
          { label: "Welding Trousers & Spats", href: "/safety/clothing/trousers" },
        ],
      },
      {
    ...
    children: [
      {
        ...
        items: [
          { label: "Kemper MaxiFil", href: "/safety/fume/kemper-maxifil" },
          { label: "Kemper MiniFil", href: "/safety/fume/kemper-minifil" },
          { label: "Kemper ProfiMaster", href: "/safety/fume/kemper-profimaster" },
          { label: "Kemper SmartMaster", href: "/safety/fume/kemper-smartmaster" },
        ],
      },
      {
        ...
        items: [
          { label: "Kemper Cartridge Filter Units", href: "/safety/fume/kemper-cartridge" },
          { label: "Kemper Filter Tables", href: "/safety/fume/kemper-tables" },
          { label: "Kemper FilterMaster XL", href: "/safety/fume/kemper-filtermaster" },
          { label: "Kemper SmartFil", href: "/safety/fume/kemper-smartfil" },
      ...
      },
      {
        ...
        items: [
          ...
          { label: "Kemper Wall Mounted Extraction", href: "/safety/fume/kemper-wall-mounted" },
          { label: "Kemper WeldFil", href: "/safety/fume/kemper-weldfil" },
        ],
      },
      {
    ...
    children: [
      {
        ...
        items: [
          ...
          { label: "Medium Duty Welding Benches", href: "/workshop/benches/medium-duty" },
      ...
      },
      {
        ...
        items: [
          ...
          { label: "Air Die Grinders", href: "/workshop/air-tools/die-grinders" },
          { label: "Air Drills", href: "/workshop/air-tools/drills" },
          { label: "Air Impact Wrenches", href: "/workshop/air-tools/impact-wrenches" },
          { label: "Air Needle Scalers", href: "/workshop/air-tools/needle-scalers" },
          { label: "Air Ratchet Wrenches", href: "/workshop/air-tools/ratchet-wrenches" },
          { label: "Air Riveters", href: "/workshop/air-tools/riveters" },
          { label: "Air Sanders / Polishers", href: "/workshop/air-tools/sanders" },
          { label: "Air Screwdrivers", href: "/workshop/air-tools/screwdrivers" },
      ...
      },
      {
        ...
        items: [
          { label: "Air Hoses & Accessories", href: "/workshop/air-tools/hoses" },
          ...
          { label: "Petrol Air Compressors", href: "/workshop/compressors/petrol" },
          { label: "Refrigerated Air Dryers", href: "/workshop/compressors/air-dryers" },
    ...
    children: [
      ...
      },
      {
        ...
        items: [
          ...
          { label: "Pipe Cutting Machine Spares", href: "/workshop/pipe/cutting-machines/spares" },
          { label: "Pipe Cutting Machines", href: "/workshop/pipe/cutting-machines" },
          { label: "Pipe Saw Spares & Supports", href: "/workshop/pipe/saws/spares" },
